...
class BillingFox_WooCommerce_PaymentGateway extends WC_Payment_Gateway
{
    /**
     * @var BillingFox_Api_Wrapper
     */
    private $api;

    /**
     * @var BillingFox_Api_Normalizer
     */
    private $normalizer;

    private $custom_exchange_currencies;

    public function __construct() {
        $this->normalizer = BillingFox_Plugin::getInstance()->get(BillingFox_Api_Normalizer::class);
        $this->api = BillingFox_Plugin::getInstance()->get(BillingFox_Api_Wrapper::class);

        $this->id                 = 'billingfox';
        $this->icon               = plugins_url('resources/img/billingfox.png', BILLING_FOX_PLUGIN_FILE);
        $this->has_fields         = false;
        $this->method_title       = __( 'BillingFox', BILLING_FOX_TRANSLATE );
